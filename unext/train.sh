...
python3 train.py --dataset busi --arch Unet --name ${idx}_unet_busi --img_ext .png --mask_ext .png --lr 0.0001 --epochs 400 --input_w 256 --input_h 256 --b 6 --early_stopping 10
