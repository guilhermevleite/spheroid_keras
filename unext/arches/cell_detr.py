...
from .cell_detr_backbone import Backbone, DenseNetBlock, StandardBlock, ResNetBlock
from .cell_detr_bounding_box_head import BoundingBoxHead
from .cell_detr_segmentation import MultiHeadAttention, SegmentationHead, ResFeaturePyramidBlock, ResPACFeaturePyramidBlock
from .cell_detr_transformer import Transformer
...
class CellDETR(nn.Module):
    ...
    def __init__(self,
                 ...
                 backbone_convolution: Type = nn.Conv2d,
                 backbone_normalization: Type = nn.BatchNorm2d,
                 backbone_activation: Type = nn.ReLU,
                 backbone_pooling: Type = nn.AvgPool2d,
                 bounding_box_head_features: Tuple[Tuple[int, int], ...] = ((128, 64), (64, 16), (16, 4)),
                 bounding_box_head_activation: Type = nn.ReLU,
                 classification_head_activation: Type = nn.ReLU,
                 num_encoder_layers: int = 3,
                 num_decoder_layers: int = 2,
                 dropout: float = 0.0,
                 transformer_attention_heads: int = 8,
                 transformer_activation: Type = nn.ReLU,
                 ...
                 segmentation_head_activation: Type = nn.ReLU,
