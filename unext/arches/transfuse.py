...
class TransFuse_S(nn.Module):
    def __init__(self,
        ...
        print("TRANSFORMER CRIADO COM SUCESSO")
        ...
        print("TRANSFUSE CRIADA COM SUCESSO")

    def forward(self, imgs, labels=None):
        print(f"Passou para o DEIT small patch16 224 {imgs.shape}")
        # bottom-up path
