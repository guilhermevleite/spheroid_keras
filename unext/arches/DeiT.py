...
class DeiT(VisionTransformer):
    ...
    def forward(self, x):
        ...
        print(f"\t\tx embed {x.shape} num_patches {self.patch_embed.num_patches} {(self.pos_embed).shape}")
        pe = self.pos_embed
        print(f"\t\tpe embed {pe.shape}")
